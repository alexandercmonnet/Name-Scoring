 ...
 */
public class AlphabeticLastNameSortingServiceImpl implements SortingService {

    @Override
    public void sortNameList(List<Name> namesList) {
        Collections.sort(namesList, (name1, name2) -> name1.getLastName().compareTo(name2.getLastName()));
    }
}